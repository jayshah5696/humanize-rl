...
|---|---|---|---|---|---|
| A1_instruction_length | **FAIL** | `{'p10': 90, 'p50': 90, 'p90': 90}` | `{'p90_min': 200, 'p10_max': 80}` | `{'p50_min': 110, 'p50_max': 170}` |  |
| A2_constraint_density | **PASS** | `8` | `4` | `5` |  |
| A3_cell_coverage | **FAIL** | `{'filled': 0, 'cells_total': 40, 'unique_cells': 1}` | `25` | `30` |  |
| A4_embedding_distance | **WARN** | `None` | `0.55` | `0.62` | too few tasks |
| A5_author_balance | **FAIL** | `75.0` | `10` | `5` | observed={'google/gemini-3.1-flash-lite-preview': 1.0} |
